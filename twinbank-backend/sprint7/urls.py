...
urlpatterns = [
    ...
    path('api/cuentas/update_balance/', CuentaViewSet.as_view({'put': 'update_balance'}), name='update-balance'),
    ...
    path('api/prestamos/branch_loans/', PrestamosViewSet.as_view({'get': 'branch_loans'}), name='branch-loans'),
    path('api/prestamos/prestamo/<int:pk>/', PrestamoDetail.as_view(), name='prestamo-detail'),
